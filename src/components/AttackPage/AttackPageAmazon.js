...
const AttackPageAmazon = () => {
  useEffect(() => {
    const visitCountRef = ref(database, "visits/amazon-attack");
    onValue(
      visitCountRef,
      (snapshot) => {
  ...
  return (
    <div style={styles.container}>
      <div>
        <img src={amazonIcon} alt="amazon icon" style={styles.image} />
...
export default AttackPageAmazon;
